...
public class WarArgumentChest extends AbstractArgumentChest
{
	...
	public String getHelpMessage()
	{
		...
		return  "WAR exporter. Exports workspace solutions into .war files.\n"
			...
			+ "				Active solution is the current solution from -s list. If false, it will create a war with no solution included.\n"
			+ "				Default: true\n"
			+ "        -" + noneActiveSolutions+ " ... space separated list of solutions that but are not in the active\n"
			+ "             solution modules. If active is false no solution will be exported in war.\n"
