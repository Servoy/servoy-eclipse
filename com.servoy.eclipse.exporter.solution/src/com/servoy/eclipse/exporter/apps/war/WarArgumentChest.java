...
public class WarArgumentChest extends AbstractArgumentChest
{
	...
	public String getHelpMessage()
	{
		...
		return  "WAR exporter. Exports workspace solutions into .war files.\n"
			...
			+ "             Default: none is excluded.\n"
			+ "        -active <true/false> ... export active solution (and its modules).\n"
			+ "				Active solution is the solution from -s parameter. \n"
			+ "	            If false, it will create a war with no solution included.\n"
			+ "	            In such situation solutions have to be imported from admin page.\n"
			+ "				Default: true\n"
			+ "        -" + noneActiveSolutions+ " ... space separated list of solutions that must be exported\n"
			+ "             but are not in the active solution modules (for example batch processor).\n"
			+ "             If active is false no solution will be exported in war.\n"
