...
import com.servoy.eclipse.notification.mylyn.AnimationUtil.FadeJob;
import com.servoy.eclipse.notification.mylyn.AnimationUtil.IFadeListener;
...
public abstract class AbstractNotificationPopup extends Window
{
	...
	private Image closeImg, closeHoverImg;
...
//		}
	...
	protected void createTitleArea(Composite parent)
	{
		...
		button.setImage(closeImg);
		button.addMouseTrackListener(new MouseTrackAdapter()
		{
			@Override
			public void mouseEnter(MouseEvent e)
			{
				button.setImage(closeHoverImg);
			}
	...
	private void initResources()
	{
		...
		closeImg = Activator.imageDescriptorFromPlugin(Activator.PLUGIN_ID, "icons/notification-close.gif").createImage();
		closeHoverImg = Activator.imageDescriptorFromPlugin(Activator.PLUGIN_ID, "icons/notification-close-active.gif").createImage();
	}
	...
	public boolean close()
	{
		...
		if(closeHoverImg != null)
		{
			closeHoverImg.dispose();
		}
