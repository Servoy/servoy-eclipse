...
public class CommitAction extends SolutionAction
{
	...
	protected void executeAction(IAction action) throws InvocationTargetException, InterruptedException
	{
		...
		ServoyTeamProvider.doCommit(mappings);
	}

	/**
	 * Indicate whether the commit should override incoming changes.
	 * 
	 * @return whether the commit should override incoming changes.
	 */
