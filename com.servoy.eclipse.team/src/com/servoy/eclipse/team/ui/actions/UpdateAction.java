...
public class UpdateAction extends SolutionAction
{
	...
	protected void executeAction(IAction action) throws InvocationTargetException, InterruptedException
	{
		...
		ServoyTeamProvider.doUpdate(mappings);
	}

	/**
	 * Indicate whether the action should overwrite outgoing changes. By default, the update action does not override local modifications.
	 * 
