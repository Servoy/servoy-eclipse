...
export abstract class ServoyPublicService {
    ...
    public abstract showMessageDialog(dialogTitle: string, dialogMessage: string, styleClass: string, values: string[], buttonsText: string[], inputType: string, defaultButtonIndex: number, okButtonText?: string): Promise<string>;
