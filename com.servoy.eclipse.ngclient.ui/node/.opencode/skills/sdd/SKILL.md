...
# SDD — Spec-Driven Development Pipeline (Servoy TiNG)
...
When approved, use `git status` to see all changes. Stage every file belonging
to this feature.

**Include:** feature code, spec file, test files
