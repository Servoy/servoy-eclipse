...
export class ServoyPublicServiceImpl extends ServoyPublicService {
    ...
    showMessageDialog(dialogTitle: string, dialogMessage: string, styleClass: string, values: string[], buttonsText: string[], okButtonText?:string): Promise<string> {
        return this.applicationService.showMessageDialog(dialogTitle, dialogMessage, styleClass, values, buttonsText,okButtonText);
    }
