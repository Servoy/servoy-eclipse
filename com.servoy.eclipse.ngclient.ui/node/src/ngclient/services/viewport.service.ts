...
export class ViewportService {
    ...
    public queueChange(viewPort: any[], internalState: any, deep:boolean, idx: number, columnName: string, newValue: any, oldValue?:any) {
        ...
        let conversionInfo = internalState.viewportConversions ? internalState.viewportConversions[idx] : undefined;
        ...
        let r : ColumnRef = {_svyRowId: (internalState.forFoundset !== undefined ? internalState.forFoundset().viewPort.rows[idx]._svyRowId : viewPort[idx]._svyRowId),
