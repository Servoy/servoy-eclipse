        ...
        for ( const beanname in formData ) {
            ...
            for ( const property in formData[beanname] ) {
                ...
                if ( beanConversion && beanConversion[property] ) {
                    value = this.converterService.convertFromServerToClient( value, beanConversion[property], comp.model[property], (property: string) => comp.model ? comp.model[property] : comp.model);
                }
