...
describe('ValuelistConverter', () => {
  ...
  const createDefaultValuelist = () =>
    ({
      values: [
        { displayValue: 'abbba', realValue: 1 },
        { displayValue: 'bbbbaab', realValue: 2 },
        { displayValue: 'caaabbc', realValue: 3 },
      ],
      valuelistid: 1073741880,
    }) as IValuelistTValueFromServer;

  it('should convert from server to client', () => {
    const val: IValuelist = converterService.convertFromServerToClient(createDefaultValuelist(), valuelistType, undefined as any, undefined as any, undefined as any, propertyContext);
  ...
  it('should get display value', async () => {
    ...
    converterService.convertFromServerToClient(
      { handledID: { id: clientChange.id, value: true }, getDisplayValue: 'd' } as IValuelistTValueFromServer,
      valuelistType,
      val,
      undefined as any,
      undefined as any,
    ...
    let display: any;
    val.getDisplayValue(realValue).subscribe(
      (response) => {
        display = response;
      },
      (response) => {
    ...
    converterService.convertFromServerToClient(
      { handledID: { id: clientChange.id, value: true }, getDisplayValue: realValue } as IValuelistTValueFromServer,
      valuelistType,
      val,
      undefined as any,
      undefined as any,
  ...
  it('should filter list', async () => {
    let val: IValuelist = converterService.convertFromServerToClient(createDefaultValuelist(), valuelistType, undefined as any, undefined as any, undefined as any, propertyContext);
    expect(val).toBeDefined();
    expect(val.length).toBe(3);
    ...
    val = converterService.convertFromServerToClient(
      { handledID: { id: 2, value: true }, values: [] } as IValuelistTValueFromServer,
      valuelistType,
      val,
      undefined as any,
      undefined as any,
    ...
    val = converterService.convertFromServerToClient({ handledID: { id: 3, value: false } } as IValuelistTValueFromServer, valuelistType, val, undefined as any, undefined as any, propertyContext);
    await new Promise((resolve) => setTimeout(resolve, 1));
