...
export class RecordRefType implements IType<any> {
  ...
  fromClientToServer(
    newClientData: RowValue | RecordRefForServer | ServerSentRecordRef,
    _oldClientData: any,
    _propertyContext: IPropertyContext,
  ): [any, RowValue | RecordRefForServer | ServerSentRecordRef] {
    if (newClientData) {
...
const instanceOfServerSentRecordRef = (obj: any): obj is ServerSentRecordRef => obj != null && (obj as ServerSentRecordRef).recordhash !== undefined;
