...
export class FoundsetTreeType implements IType<FoundsetTree> {
  ...
  fromServerToClient(serverJSONValue: any, currentClientValue: FoundsetTree, _propertyContext: IPropertyContext): FoundsetTree {
...
export class FoundsetTree extends Array<any> implements IFoundsetTree, IChangeAwareValue, IUIDestroyAwareValue {
  constructor(
    ...
    private internalState: FoundsetTreeState,
    values?: any[],
  ) {
    super();
