...
import {
  CustomArrayTypeFactory,
  CustomArrayType,
  ICATFullValueFromServer,
  ICATGranularUpdatesToServer,
  ICATNoOpToServer,
  ICATFullArrayToServer,
  ICATGranularUpdatesFromServer,
  ICATOpTypeEnum,
} from './json_array_converter';
import {
...
describe('JSONArrayConverter', () => {
    ...
    typesRegistry.addComponentClientSideSpecs({
      someTabPanelSpec: {
        p: {
          ...
          stringArrayWithShallowOnElements: { t: [CustomArrayTypeFactory.TYPE_FACTORY_NAME, { t: null, s: 2 }] as ITypeFromServer, s: 1 } as IPropertyDescriptionFromServerWithMultipleEntries,
          tabArray: { t: [CustomArrayTypeFactory.TYPE_FACTORY_NAME, [CustomObjectTypeFactory.TYPE_FACTORY_NAME, 'Tab']] as ITypeFromServer, s: 1 } as IPropertyDescriptionFromServerWithMultipleEntries,
  ...
  const createSimpleUntypedObjectArray = (): ICATFullValueFromServer => ({
    v: [
      ...
      [1, 2, 3],
      {
        ...
        _V: {
          x: { _T: ObjectType.TYPE_NAME, _V: ['bla', { _T: DateType.TYPE_NAME_SVY, _V: '2007-12-03T' }] },
          y: 8,
        },
  ...
  it('type should be created an array from server to client', () => {
    const val: string[] = converterService.convertFromServerToClient(
      createDefaultStringArrayJSON(),
      stringArrayType,
      undefined as any,
      undefined as any,
      undefined as any,
      getParentPropertyContext(stringArrayPushToServer),
    );
  ...
  it('updates from server to client', () => {
    let val: string[] = converterService.convertFromServerToClient(
      createDefaultStringArrayJSON(),
      stringArrayType,
      undefined as any,
      undefined as any,
    ...
    val = converterService.convertFromServerToClient(
      {
        ...
        vEr: 1,
      } as ICATGranularUpdatesFromServer,
      stringArrayType,
      val,
      undefined as any,
      undefined as any,
  ...
  it('simple change of 1 index', () => {
    const arr = converterService.convertFromServerToClient(
      createDefaultStringArrayJSON(),
      stringArrayWithShallowOnElementsType,
      undefined as any,
      undefined as any,
      undefined as any,
      getParentPropertyContext(stringArrayWithShallowOnElementsPushToServer),
    );
    ...
    const changes: ICATGranularUpdatesToServer = converterService.convertFromClientToServer(
      val,
      stringArrayWithShallowOnElementsType,
      val,
      getParentPropertyContext(stringArrayWithShallowOnElementsPushToServer),
    ...
    const changes2: ICATNoOpToServer = converterService.convertFromClientToServer(
      val,
      stringArrayWithShallowOnElementsType,
      val,
      getParentPropertyContext(stringArrayWithShallowOnElementsPushToServer),
  ...
  it('remove of 1 index', () => {
    ...
    const arr = converterService.convertFromServerToClient(
      ...
      undefined as any,
      undefined as any,
      getParentPropertyContext(PushToServerEnum.ALLOW),
    );
    const valAsSeenInternally = arr as IChangeAwareValue;
    const val = arr as String[];
    valAsSeenInternally.getInternalState().setChangeListener(() => {});
    ...
    val.splice(1, 1);
    const changes: ICATFullArrayToServer = converterService.convertFromClientToServer(
      val,
      stringArrayWithShallowOnElementsType,
      val,
      getParentPropertyContext(stringArrayWithShallowOnElementsPushToServer),
  ...
  it('type should be created an array from server to client with custom json objects', () => {
    const arr = converterService.convertFromServerToClient(
      createArrayWithJSONObject(),
      tabArrayWithShallowOnElementsType,
      undefined as any,
      undefined as any,
      undefined as any,
    ...
    const changes2: ICATNoOpToServer = converterService.convertFromClientToServer(val, tabArrayWithShallowOnElementsType, val, getParentPropertyContext(tabArrayWithShallowOnElementsPushToServer))[0];
    expect(changes2.n).toBe(true);
  });

  it('updates from server to client for custom object element', () => {
    let arr = converterService.convertFromServerToClient(
      createArrayWithJSONObject(),
      tabArrayWithShallowOnElementsType,
      undefined as any,
      undefined as any,
    ...
    arr = converterService.convertFromServerToClient(
      {
        g: [{ op: [2, 2, ICATOpTypeEnum.CHANGED], d: [{ u: [{ k: 'name', v: 'KM' }], vEr: 1 } as ICOTGranularUpdatesFromServer] }],
        vEr: 1,
      } as ICATGranularUpdatesFromServer,
      tabArrayWithShallowOnElementsType,
      arr,
  ...
  it('change of one tab value', () => {
    ...
    let changes2: ICATNoOpToServer = converterService.convertFromClientToServer(
      valSeenExternally,
      tabArrayWithShallowOnElementsType,
      valSeenExternally,
      getParentPropertyContext(tabArrayWithShallowOnElementsPushToServer),
    ...
    changes2 = converterService.convertFromClientToServer(
      valSeenExternally,
      tabArrayWithShallowOnElementsType,
      valSeenExternally,
      getParentPropertyContext(tabArrayWithShallowOnElementsPushToServer),
  ...
  it('delete 1 tab', () => {
    ...
    const changes2 = converterService.convertFromClientToServer(val, tabArrayWithShallowOnElementsType, val, getParentPropertyContext(tabArrayWithShallowOnElementsPushToServer))[0];
    expect(changes2.n).toBe(true);
  });
  ...
  it('send array as arg to handler, change a tab by ref', () => {
    ...
    const changesAndVal: [ICATFullArrayToServer, Tab[]] = converterService.convertFromClientToServer(
      val,
      tabArrayWithShallowOnElementsType,
      undefined,
    ...
    const changes2: ICATGranularUpdatesToServer = converterService.convertFromClientToServer(
      val,
      tabArrayWithShallowOnElementsType,
      val,
      getParentPropertyContext(tabArrayWithShallowOnElementsPushToServer),
  ...
  it('send obj from model (with push to server reject) as arg to handler', () => {
    const val = converterService.convertFromServerToClient(
      { v: ['test1'], vEr: 1 },
      untypedObjectArrayWithREJECTOnElementsType,
      undefined as any,
      undefined as any,
      undefined as any,
      getParentPropertyContext(untypedObjectArrayWithREJECTOnElementsPushToServer),
    );
    ...
    const changesAndVal: [ICOTFullObjectToServer, ICustomArrayValue<any>] = converterService.convertFromClientToServer(
      val,
      untypedObjectArrayWithREJECTOnElementsType,
      undefined,
      PushToServerUtils.PROPERTY_CONTEXT_FOR_OUTGOING_ARGS_AND_RETURN_VALUES,
  ...
  it('create a tabholder with 3 tabs in its array', () => {
    const arr = converterService.convertFromServerToClient(
      createTabHolderJSONWithFilledArray('test'),
      tabHolderElementsType,
      undefined as any,
      undefined as any,
      undefined as any,
      getParentPropertyContext(tabHolderElementsPushToServer),
    );
    const valAsSeenInternally = arr as IChangeAwareValue;
    ...
    const changes2: ICOTNoOpToServer = converterService.convertFromClientToServer(val, tabHolderElementsType, val, getParentPropertyContext(tabHolderElementsPushToServer))[0];
    expect(changes2.n).toBe(true);
  });
  ...
  it('update a tab in the tabs array of the TabHolder', () => {
    ...
    const changes: ICOTGranularUpdatesToServer = converterService.convertFromClientToServer(val, tabHolderElementsType, val, getParentPropertyContext(tabHolderElementsPushToServer))[0];
  ...
  it('test deep change in an "object[]" with ALLOW', () => {
    const val = converterService.convertFromServerToClient(
      createSimpleUntypedObjectArray(),
      untypedObjectArrayWithALLOWOnElementsType,
      undefined as any,
      undefined as any,
      undefined as any,
      getParentPropertyContext(untypedObjectArrayWithALLOWOnElementsPushToServer),
    );
    ...
    let changes: ICATGranularUpdatesToServer = converterService.convertFromClientToServer(
      val,
      untypedObjectArrayWithALLOWOnElementsType,
      val,
      getParentPropertyContext(untypedObjectArrayWithALLOWOnElementsPushToServer),
    ...
    changes = converterService.convertFromClientToServer(val, untypedObjectArrayWithALLOWOnElementsType, val, getParentPropertyContext(untypedObjectArrayWithALLOWOnElementsPushToServer))[0];
    ...
    changes2 = converterService.convertFromClientToServer(val, untypedObjectArrayWithALLOWOnElementsType, val, getParentPropertyContext(untypedObjectArrayWithALLOWOnElementsPushToServer))[0];
    expect(changes2.n).toBe(true);
  });
  ...
  it('test deep change in an "object[]" with SHALLOW', () => {
    const val = converterService.convertFromServerToClient(
      createSimpleUntypedObjectArray(),
      untypedObjectArrayWithSHALLOWOnElementsType,
      undefined as any,
      undefined as any,
      undefined as any,
      getParentPropertyContext(untypedObjectArrayWithSHALLOWOnElementsPushToServer),
    );
    ...
    changes = converterService.convertFromClientToServer(val, untypedObjectArrayWithSHALLOWOnElementsType, val, getParentPropertyContext(untypedObjectArrayWithSHALLOWOnElementsPushToServer))[0];
    ...
    changes2 = converterService.convertFromClientToServer(val, untypedObjectArrayWithSHALLOWOnElementsType, val, getParentPropertyContext(untypedObjectArrayWithSHALLOWOnElementsPushToServer))[0];
    expect(changes2.n).toBe(true);
  });
  ...
  it('test deep change in an "object[]" with DEEP', () => {
    const val = converterService.convertFromServerToClient(
      createSimpleUntypedObjectArray(),
      untypedObjectArrayWithDEEPOnElementsType,
      undefined as any,
      undefined as any,
      undefined as any,
      getParentPropertyContext(untypedObjectArrayWithDEEPOnElementsPushToServer),
    );
    ...
    changes = converterService.convertFromClientToServer(val, untypedObjectArrayWithDEEPOnElementsType, val, getParentPropertyContext(untypedObjectArrayWithDEEPOnElementsPushToServer))[0];
    ...
    changes2 = converterService.convertFromClientToServer(val, untypedObjectArrayWithDEEPOnElementsType, val, getParentPropertyContext(untypedObjectArrayWithDEEPOnElementsPushToServer))[0];
    expect(changes2.n).toBe(true);
  });
  ...
  it('when an already smart value (received as return value from an server side api call for example) is assigned into the model into a new location and sent to server, it should still work - have a correct change listener etc.', () => {
    // in model
    const val = converterService.convertFromServerToClient(
      createArrayWithJSONObject() as ICATFullValueFromServer,
      tabArrayWithShallowOnElementsType,
      undefined as any,
      undefined as any,
      undefined as any,
    ...
    const childTab = converterService.convertFromServerToClient(
      createTabJSON('iAmArg'),
      tabJustForTypeType,
      undefined as any,
      undefined as any,
      undefined as any,
    ...
    // simulate a send to server as argument to a handler for this array (oldVal undefined) - to make sure it doesn't messup it's state if it's also a model prop. (it used getParentPropertyContext above which is for a model prop)
    const changesAndVal: [ICATGranularUpdatesToServer, any] = converterService.convertFromClientToServer(
      tabArray,
      tabArrayWithShallowOnElementsType,
      tabArray,
      getParentPropertyContext(tabArrayWithShallowOnElementsPushToServer),
