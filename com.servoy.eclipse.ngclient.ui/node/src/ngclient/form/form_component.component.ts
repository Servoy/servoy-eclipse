...
@Component({
    ...
    <!-- <ng-template #bootstrapcomponentsTabpanel let-state="state"><servoybootstrap-tabpanel  [visible]="state.model.visible" [containerStyleClass]="state.model.containerStyleClass" [tabs]="state.model.tabs" (tabsChange)="datachange(state.name,'tabs',$event)" [tabIndex]="state.model.tabIndex" (tabIndexChange)="datachange(state.name,'tabIndex',$event)" [styleClass]="state.model.styleClass" [activeTabIndex]="state.model.activeTabIndex" (activeTabIndexChange)="datachange(state.name,'activeTabIndex',$event)" [showTabCloseIcon]="state.model.showTabCloseIcon" [size]="state.model.size" [cssPosition]="state.model.cssPosition" [closeIconStyleClass]="state.model.closeIconStyleClass" [location]="state.model.location" [attributes]="state.model.attributes" [tabSeq]="state.model.tabSeq" [height]="state.model.height" [onTabClickedMethodID]="getHandler(state,'onTabClickedMethodID')" [onChangeMethodID]="getHandler(state,'onChangeMethodID')" [onTabCloseMethodID]="getHandler(state,'onTabCloseMethodID')" [servoyApi]="getServoyApi(state)" [name]="state.name" #cmp><ng-template let-name='name'><svy-form *ngIf="isFormAvailable(name)" [name]="name"></svy-form></ng-template></servoybootstrap-tabpanel></ng-template> -->
