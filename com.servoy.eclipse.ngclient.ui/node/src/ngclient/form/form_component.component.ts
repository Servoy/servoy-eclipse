...
@Component({
    ...
    template: `
      ...
      <ng-template #servoydefaultCombobox let-state="state">
        <servoydefault-combo [servoyApi]="getServoyApi(state)" [servoyAttributes]="state.model.svy_attributes"
      ...
      <ng-template #servoydefaultTypeahead let-state="state">
        <servoydefault-typeahead [servoyApi]="getServoyApi(state)" [servoyAttributes]="state.model.svy_attributes"
                                   [onActionMethodID]="getHandler(state,'onActionMethodID')"
                                   [onDataChangeMethodID]="getHandler(state,'onDataChangeMethodID')"
                                   [onFocusGainedMethodID]="getHandler(state,'onFocusGainedMethodID')"
                                   [onFocusLostMethodID]="getHandler(state,'onFocusLostMethodID')"
      ...
      <ng-template #servoydefaultListbox let-state="state">
        <servoydefault-listbox [servoyApi]="getServoyApi(state)" [servoyAttributes]="state.model.svy_attributes"
                                   [onActionMethodID]="getHandler(state,'onActionMethodID')"
                                   [onDataChangeMethodID]="getHandler(state,'onDataChangeMethodID')"
                                   [onFocusGainedMethodID]="getHandler(state,'onFocusGainedMethodID')"
                                   [onFocusLostMethodID]="getHandler(state,'onFocusLostMethodID')"
      ...
      <ng-template #servoycoreListformcomponent let-state="state"><servoycore-listformcomponent [parentForm]="self" [listFormComponent]="state" [responsivePageSize]="state.model.responsivePageSize" [pageLayout]="state.model.pageLayout" #cmp></servoycore-listformcomponent></ng-template>
