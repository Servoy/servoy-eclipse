    ...
    private handleMessage( message ) {
        ...
        try {
            ...
            if ( obj && obj.smsgid ) {
                ...
                //                    if (this.log.debugEnabled) this.log.debug(this.log.buildMessage(() => ("sbl * Call from server with smsgid '" + obj.smsgid + "' returned a promise; will wait for it to get resolved.")));
                //                    
                ...
                Promise.resolve( responseValue ).then(( ret ) => {
                    ...
                    //                        this.log.debug(this.log.buildMessage(() => ("sbl * Promise returned by call from server with smsgid '" + obj.smsgid + "' is now resolved with value: -" + ret + "-. Sending value back to server...")));
                    //                    } 
