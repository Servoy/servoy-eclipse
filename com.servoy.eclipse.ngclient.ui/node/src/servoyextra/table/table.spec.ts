...
@Component({
  ...
  template: '<div style="position: absolute; left: 29px; top: 139px; width: 571px; height: 438px;" [servoyApi]="servoyApi" [foundset]="foundset" [columns]="columns" [minRowHeight]="minRowHeight"  [enableColumnResize]="enableColumnResize" [pageSize]="pageSize" [cellClick]="onCellClick" [responsiveHeight]="responsiveHeight"> <servoyextra-table #table [servoyApi]="servoyApi" [foundset]="foundset" [columns]="columns" [minRowHeight]="minRowHeight" [enableColumnResize]="enableColumnResize" [pageSize]="pageSize" [responsiveHeight]="responsiveHeight" [onCellClick]="cellClick" ></servoyextra-table > </div>',
})
...
describe('ServoyExtraTable', () => {
  ...
  function getFoundset(): Foundset {
    ...
    const fslinked = converterService.convertFromServerToClient(fsl_json, 'fsLinked', undefined, componentModelGetter);
    return fs;
  }
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      imports: [ServoyTestingModule, ServoyExtraComponentsModule],
    ...
    servoyApi.isInAbsoluteLayout.and.callFake(() => {
      return false;
    });
