...
export class ServoyDesignerComponent implements OnInit, AfterViewInit, OnDestroy, IDesignFormComponent {
  ...
  variantsFormTemplate =
    '{"VariantsForm":{"responsive":true,"size":{"width": 640,"height":0},"children":[{"name":"","model":{"designSize":{"width":640,"height":0},"size":{"width":400,"height":0},"addMinSize":true,"useCssPosition":{},"absoluteLayout":{"":false},"hasExtraParts":false,"styleClass":" svy-overflowx-auto svy-overflowy-auto"}},{"layout":true,"cssPositionContainer":false,"styleclass":["flex"],"attributes":{"data-justify-content":"stretch","svy-id":"variants-responsive-grid","data-align-items":"stretch","svy-layoutname":"12grid.flexcontainer","svy-priority":"1","svy-title":"flex","data-direction":"column","designclass":"variants_container"},"children":[]}]}}';

  private readonly windowRef = inject(WindowRefService);
  private readonly websocketService = inject(WebsocketService);
  private readonly formService = inject(FormService);
  private readonly services = inject(ServicesService);
  private readonly editorContentService = inject(EditorContentService);
  ...
  ngOnInit() {
    ...
    this.wsSession
      .callService('$editor', 'getStyleSheets', {
        form: formName,
        solution: this.solutionName,
        ng2: true,
      })
