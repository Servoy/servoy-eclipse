...
import { ServoyBaseComponent, TooltipDirective, SabloTabseq } from '@servoy/public';
...
@Component({
  ...
  animations: [
    trigger('slideAnimation', [
      ...
      transition('void => slide-left', [style({ left: '100%', position: 'absolute', width: '100%', height: '100%' }), animate('750ms ease-in', style({ left: '0%' }))]),
      transition('slide-left => hide', [style({ right: '0%', position: 'absolute', width: '100%', height: '100%' }), animate('750ms ease-in', style({ right: '100%' }))]),
      transition('void => slide-right', [style({ right: '100%', position: 'absolute', width: '100%', height: '100%' }), animate('750ms ease-in', style({ right: '0%' }))]),
      transition('slide-right => hide', [style({ left: '0%', position: 'absolute', width: '100%', height: '100%' }), animate('750ms ease-in', style({ left: '100%' }))]),
      transition('void => slide-down', [style({ bottom: '100%', position: 'absolute', width: '100%', height: '100%' }), animate('750ms ease-in', style({ bottom: '0%' }))]),
      transition('slide-down => hide', [style({ top: '0%', position: 'absolute', width: '100%', height: '100%' }), animate('750ms ease-in', style({ top: '100%' }))]),
      transition('void => slide-up', [style({ top: '100%', position: 'absolute', width: '100%', height: '100%' }), animate('750ms ease-in', style({ top: '0%' }))]),
      transition('slide-up => hide', [style({ bottom: '0%', position: 'absolute', width: '100%', height: '100%' }), animate('750ms ease-in', style({ bottom: '100%' }))]),
  ...
  standalone: true,
  imports: [TooltipDirective, SabloTabseq, NgTemplateOutlet],
})
