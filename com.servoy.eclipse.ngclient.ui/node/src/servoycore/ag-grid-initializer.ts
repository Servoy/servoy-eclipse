...
export const provideAgGrid = (): EnvironmentProviders => makeEnvironmentProviders([{ provide: APP_INITIALIZER, useValue: initializeAgGrid, multi: true }]);
