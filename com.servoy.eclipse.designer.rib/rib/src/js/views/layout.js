...
(function ($, undefined) {
    ...
    $.widget('rib.layoutView', $.rib.baseView, {
        ...
        options: {
            ...
            customHeaders: {
                ...
                'link': [
                    ...
                    '<link href="src/css/servoyformeditor.css" rel="stylesheet">'
                ]
            }
        },
        ...
        refresh: function (event, widget) {
            ...
            // Servoy-fix: visible does not get set (jquery-mismatch?)
...
*/
        ...
        _renderer: function (admNode, domNode) {
            ...
            if (admNode.isContainer()) {
            	if (admNode.isSortable()) $(domNode).addClass('nrc-sortable-container');
