...
if (!top.$.rib.debug())
    $(document).bind('contextmenu', function(e) { 
        // click on the element to set the selection before showing context menu
    	e.target.click()
     	e.preventDefault();
    });
...
$(function() {
    ...
    var enableEditing = function (element) {
        ...
        $(element).focus();
        ADM.fireEvent("editingStateChanged", { editing: true });
    };
    ...
    var disableEditing = function (element) {
        ...
        ADM.fireEvent("editingStateChanged", { editing: false });
    };
        ...
        targets
            .sortable({
                ...
                start: function(event, ui){
                    trackOffsets('start:   ',ui,$(this).data('uiSortable'));
                ...
                change: function(event, ui){
                    trackOffsets('change:  ',ui,$(this).data('uiSortable'));
                ...
                sort: function(event, ui){
                    ...
                    var s = $(this).data('uiSortable'), sP = s.scrollParent;
                ...
                over: function(event, ui){
                    trackOffsets('over:    ',ui,$(this).data('uiSortable'));
                ...
                out: function(event, ui){
                    trackOffsets('out:     ',ui,$(this).data('uiSortable'));
                },
                stop: function(event, ui){
                    trackOffsets('stop:    ',ui,$(this).data('uiSortable'));
                    var type, isDrop,
                    ...
                    function childIntersects(that) {
                        var intersects = false,
                            s = $(that).find(':data(uiSortable)')
                                       .not('.ui-sortable-helper');
                        s.each( function(i) {
                            var inst = $.data(this, 'uiSortable');
