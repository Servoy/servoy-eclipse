...
/**
 * Event sent by the ADM object when the user is going into/out of direct-editing mode.
 *
 * @name ADM#designReset
 * @event
 * @param {Object} event Object including boolean "editing" property.
 * @param {Any} data The data you supplied to the bind() call.
 * @see ADMEventSource.bind
 * @see ADMEventSource.unbind
 */
ADM.addEventType("editingStateChanged");
...
/**
 * Tests whether this nodes children should be dragged by the user.
 *
 * @return {Boolean} True if the nodes children should be dragged by the user.
 */
ADMNode.prototype.isSortable = function () {
    return this.isContainer() && BWidget.isSortable(this.getType());
};
