    ...
    if (elem[0] === 'connectToSortable') {
        elem[1] = function (event, ui) {
            ...
            $(o.connectToSortable).each(function() {
                var sortable = $.data(this, 'uiSortable');
...
$.map($.ui['draggable'].prototype.plugins['drag'], function (elem, index) {
    if (elem[0] === 'connectToSortable') {
        elem[1] = function (event, ui) {
            ...
            var inst = $(this).data("uiDraggable"), self = this;
            ...
            $.each(inst.sortables, function(i) {
                ...
                if(isInnerMostSortable) {
                    ...
                    if(!this.instance.isOver) {
                       ...
                       // SERVOY  this.instance.currentContainer = null;
                        // End of RIB changes
                        ////////////////////////////////////////////////////////
...
(function( $ ){
    ...
    $.data = function (elem, name, data, pvt) {
        if ( (name === "uiSortable") && !data && getOwnerWindow(elem) !== window)
