...
(function($, undefined) {
    ...
    $.widget('rib.builder', {
        ...
        _create: function() {
            ...
            this._designReset(null, this);
            o.model.bind('designReset', this._designReset, this);
            o.model.bind('selectionChanged', this._selectionChanged, this);
            o.model.bind('activePageChanged', this._activePageChanged, this);
            o.model.bind('editingStateChanged', this._editingStateChanged, this);
		...
		.addClass('servoyhide');
           ...
           /* this.ui.projectView = $('<div/>').appendTo(container)
            ...
            this.ui.layoutView.append('<div class="servoyhide panel right">');
            this.ui.layoutView.find('.panel.left')
                ...
                .append('<div class="servoyhide panel-section-header flex0 vbox"><span class="title">Widget Categories</span></div>')
                .append('<div class="servoyhide widgetView flex0 vbox"></div>')
            ...
            this.ui.codeView = $('<div/>').appendTo(container)
                .attr('id', 'codeView')
                .addClass('servoyhide view code flex1 hbox');
            ...
            this.ui.codeViewLeftPanel = this.ui.codeView.find('.panel.left')
                ...
                .append('<div class="pageView flex0 vbox"></div>')
                .append('<div class="outlineView flex0 vbox"></div>')
                .append('<div class="servoyhide panel-section-header property_title flex0 vbox"></div>')
                .append('<div class="servoyhide propertyView flex0 vbox"></div>');

            this.ui.liveView = $('<div/>').appendTo(container)
                .attr('id', 'liveView')
                .addClass('servoyhide view live flex1');
	    ...
	    if (false) { // SERVOY: do not create the navbar 
        ...
        _designReset: function(event, widget) {
            if (this.design) {
                this.design.unbind('modelUpdated', $.servoy.handleModelUpdated);
            }
            this.design = event && event.design ||
                          this.options.model.getDesignRoot();
            if (typeof ($.servoy) != 'undefined') this.design.bind('modelUpdated', $.servoy.handleModelUpdated, widget);
        },
        ...
        _selectionChanged: function(event, widget) {
			callbackSelectionChanged(JSON.stringify(event.node._properties))
        },

        _editingStateChanged: function(event, widget) {
        	callbackEditingStateChanged(event.editing)
        },
...
$(function() {
    ...
    if (false /* Servoy */ && (!supportedBrowser.test(navigator.userAgent) ||
