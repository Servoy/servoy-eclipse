...
public class FormToolHandler implements IToolHandler
{
	...
	{
		System.out.println("========================================");
		System.out.println("[FormToolHandler] handleOpenForm CALLED");
		...
		try
		{
			...
			System.out.println("[FormToolHandler] Extracted parameters - name: " + name + ", create: " + create + 
			...
			Display.getDefault().syncExec(() -> {
				...
				{
					System.out.println("[FormToolHandler] openForm() threw exception: " + e.getMessage());
					e.printStackTrace();
					exception[0] = e;
				}
			});
			...
			if (exception[0] != null)
			{
				System.out.println("[FormToolHandler] Form operation failed");
			...
			System.out.println("[FormToolHandler] Form operation succeeded: " + result[0]);
			return McpSchema.CallToolResult.builder()
	...
	{
		System.out.println("========================================");
		System.out.println("[FormToolHandler] handleSetMainForm CALLED");
	...
	{
		System.out.println("========================================");
		System.out.println("[FormToolHandler] handleListForms CALLED");
		...
		String dataSource, String extendsForm, boolean setAsMainForm, Map<String, Object> properties, Map<String, Object> args) throws RepositoryException
	{
		...
		if (form != null)
		{
			System.out.println("[FormToolHandler.openOrCreateForm] Form exists, opening: " + name);
			// Form exists - open it
		}
		else if (create)
		{
		...
		{
			System.out.println("[FormToolHandler.openOrCreateForm] Applying properties: " + properties);
		...
		{
			System.out.println("[FormToolHandler.openOrCreateForm] Setting parent form: " + extendsForm);
	...
	{
		System.out.println("[FormToolHandler.createNewForm] Creating form: " + formName);
	...
	private void applyFormProperties(Form form, Map<String, Object> properties, ServoyProject servoyProject) throws RepositoryException
	{
		for (Map.Entry<String, Object> entry : properties.entrySet())
		{
			...
			System.out.println("[FormToolHandler.applyFormProperties] Setting property: " + propName + " = " + propValue);
			...
			try
			{
				switch (propName)
				{
					...
					default:
						System.out.println("[FormToolHandler.applyFormProperties] WARNING: Unknown property: " + propName);
						break;
				}
			}
			catch (Exception e)
			{
				System.out.println("[FormToolHandler.applyFormProperties] ERROR setting property " + propName + ": " + e.getMessage());
	...
	private void setFormParent(Form form, String parentFormName, ServoyProject servoyProject) throws RepositoryException
	{
		...
		System.out.println("[FormToolHandler.setFormParent] Set parent form to: " + parentFormName);
	}
	...
	{
		System.out.println("========================================");
		System.out.println("[FormToolHandler] handleGetCurrentForm CALLED");
		...
		try
		{
			...
			display.syncExec(() -> {
				try
				{
					...
					if (activePage != null)
					{
						...
						if (activeEditor != null)
						{
							...
							System.out.println("[FormToolHandler] Active editor: '" + editorTitle + "' (type: " + editorClass + ")");
							...
							{
								System.out.println("[FormToolHandler] Exception during form lookup: " + e.getMessage());
							...
							if (form != null)
							{
								...
								System.out.println("[FormToolHandler] SUCCESS - Form detected: " + result[0]);
							}
							else
							{
								...
								System.out.println("[FormToolHandler] FAIL - " + errorDetail[0]);
							}
						}
						else
						{
				...
				catch (Exception e)
				{
					...
					System.out.println("[FormToolHandler] EXCEPTION - " + errorDetail[0]);
					e.printStackTrace();
		...
		{
			System.out.println("[FormToolHandler] EXCEPTION: " + e.getMessage());
			e.printStackTrace();
