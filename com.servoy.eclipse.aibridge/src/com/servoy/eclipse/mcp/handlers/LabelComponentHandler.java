...
public class LabelComponentHandler implements IToolHandler
{
	...
	{
		System.out.println("========================================");
		System.out.println("[LabelComponentHandler] handleAddLabel CALLED");
	...
	{
		System.out.println("========================================");
		System.out.println("[LabelComponentHandler] handleUpdateLabel CALLED");
	...
	{
		System.out.println("========================================");
		System.out.println("[LabelComponentHandler] handleDeleteLabel CALLED");
	...
	{
		System.out.println("========================================");
		System.out.println("[LabelComponentHandler] handleListLabels CALLED");
	...
	{
		System.out.println("========================================");
		System.out.println("[LabelComponentHandler] handleGetLabelInfo CALLED");
				...
				if (activePage != null)
				{
					...
					if (activeEditor != null)
					{
						...
						if (form != null)
						{
							...
							System.out.println("[LabelComponentHandler] Current form detected: " + result[0]);
						}
						else
						{
							System.out.println("[LabelComponentHandler] Active editor does not contain a form");
						}
					}
					else
					{
						System.out.println("[LabelComponentHandler] No active editor found");
					}
				}
				else
				{
					System.out.println("[LabelComponentHandler] No active workbench page found");
				}
			}
			catch (Exception e)
			{
