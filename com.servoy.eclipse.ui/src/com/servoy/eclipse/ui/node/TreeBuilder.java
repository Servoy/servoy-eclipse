...
public class TreeBuilder
{
	...
	public static UserNode[] createJSArray(IImageLookup imageLookup)
	{
		...
		return createTypedArray(imageLookup, com.servoy.eclipse.core.scripting.docs.Array.class, UserNodeType.ARRAY, dlm);
	}
	...
	public static UserNode[] createJSDate(IImageLookup imageLookup)
	{
		...
		return createTypedArray(imageLookup, com.servoy.eclipse.core.scripting.docs.Date.class, UserNodeType.DATE, dlm);
	}

	public static UserNode[] createJSString(IImageLookup imageLookup)
	{
		return createTypedArray(imageLookup, com.servoy.eclipse.core.scripting.docs.String.class, UserNodeType.STRING, null);
	}

	public static UserNode[] createJSMathFunctions(IImageLookup imageLookup)
	{
		return createTypedArray(imageLookup, com.servoy.eclipse.core.scripting.docs.Math.class, UserNodeType.FUNCTIONS_ITEM, null);
	}

	public static UserNode[] createFlows(IImageLookup imageLookup)
	{
		return createTypedArray(imageLookup, com.servoy.eclipse.core.scripting.docs.Statements.class, UserNodeType.STATEMENTS_ITEM, null);
	}

	public static UserNode[] createXMLListMethods(IImageLookup imageLookup)
	{
		return createTypedArray(imageLookup, com.servoy.eclipse.core.scripting.docs.XMLList.class, UserNodeType.XML_LIST_METHODS, null);
	}

	public static UserNode[] createXMLMethods(IImageLookup imageLookup)
	{
		return createTypedArray(imageLookup, com.servoy.eclipse.core.scripting.docs.XML.class, UserNodeType.XML_METHODS, null);
	}

	public static UserNode[] createJSRegexp(IImageLookup imageLookup)
	{
		return createTypedArray(imageLookup, com.servoy.eclipse.core.scripting.docs.RegExp.class, UserNodeType.REGEXP, null);
	}
		...
		if (dm != null)
		{
			...
			if (objDoc != null)
			{
				...
				for (IFunctionDocumentation fdoc : objDoc.getFunctions())
				{
					...
					{
						dlm.add(new UserNode(fdoc.getMainName(), type, fdoc.getSignature("."), fdoc.getSample(), fdoc.getDescription(), null, //$NON-NLS-1$
							propertiesIcon));
					}
				}
				for (IFunctionDocumentation fdoc : objDoc.getFunctions())
