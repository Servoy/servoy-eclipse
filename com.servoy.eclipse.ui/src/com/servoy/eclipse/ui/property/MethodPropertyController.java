...
public class MethodPropertyController<P> extends PropertyController<P, Object>
{
	...
	public MethodPropertyController(String id, String displayName, PersistContext persistContext, boolean includeNone, boolean includeDefault,
		boolean includeFormMethods, boolean includeGlobalMethods)
	{
		...
		setLabelProvider(new SolutionContextDelegateLabelProvider(new FormContextDelegateLabelProvider(new MethodLabelProvider(persistContext, true,
			!includeDefault), persistContext.getContext()), persistContext.getContext()));
	...
	{
		ILabelProvider methodLabelProvider = new FormContextDelegateLabelProvider(new MethodLabelProvider(persistContext, false, !includeDefault),
			...
			public MethodWithArguments openDialogBox(Control cellEditorWindow)
			{
				if (MethodPropertyController.this.isReadOnly())
				{
					...
					if (persistContext.getContext() instanceof Form)
					{
						...
						IScriptProvider scriptMethod = ModelUtils.getScriptMethod(persistContext.getPersist(), persistContext.getContext(), null, val.methodId);
	...
	public static class MethodValueEditor implements IValueEditor<MethodWithArguments>
	{
		...
		{
			return ModelUtils.getScriptMethod(persistContext.getPersist(), persistContext.getContext(), null, value.methodId) != null;
		}

		public void openEditor(MethodWithArguments value)
		{
			EditorUtil.openScriptEditor(ModelUtils.getScriptMethod(persistContext.getPersist(), persistContext.getContext(), null, value.methodId), true);
		}
	}
