	...
	public static class TitledBorderPropertySource extends ComplexPropertySourceWithStandardReset<TitledBorder>
	{
		...
		protected TitledBorder setComplexPropertyValue(Object id, Object v)
		{
			...
			if (JUSTIFICATION.equals(id))
			{
				...
				return new TitledBorder(null, border.getTitle(),
					titleJustification == null ? TitledBorder.DEFAULT_JUSTIFICATION : titleJustification.intValue(), border.getTitlePosition(),
					border.getTitleFont(), border.getTitleColor());
			}
			if (POSITION.equals(id))
			{
				...
				return new TitledBorder(null, border.getTitle(), border.getTitleJustification(),
					titlePosition == null ? TitledBorder.DEFAULT_POSITION : titlePosition.intValue(), border.getTitleFont(), border.getTitleColor());
			}
			if (FONT.equals(id))
			{
