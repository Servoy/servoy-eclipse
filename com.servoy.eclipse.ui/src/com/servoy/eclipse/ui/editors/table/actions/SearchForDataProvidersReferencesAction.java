 ...
 *
 */
public class SearchForDataProvidersReferencesAction extends Action implements ISelectionChangedListener
{
	private IColumn selectedDataProvider;

	public SearchForDataProvidersReferencesAction()
	{
		this(null);
	}
	...
	public void run()
	{
		ISearchQuery query = new DataProviderSearch(selectedDataProvider);
	...
	public void selectionChanged(SelectionChangedEvent event)
	{
		...
		if (sel.size() == 1 && sel.getFirstElement() instanceof IColumn) selectedDataProvider = (IColumn)sel.getFirstElement();
		setEnabled(selectedDataProvider != null);
	}

	public void setSelectedDataProvider(IColumn selectedDataProvider)
	{
		this.selectedDataProvider = selectedDataProvider;
	}
}
