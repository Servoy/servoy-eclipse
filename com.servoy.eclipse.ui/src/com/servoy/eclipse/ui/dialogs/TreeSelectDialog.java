		...
		else
		{
			...
			groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(GroupLayout.TRAILING).add(
				...
				groupLayout.createSequentialGroup().addContainerGap().add(
					groupLayout.createParallelGroup(GroupLayout.LEADING).add(GroupLayout.TRAILING, treeViewer, GroupLayout.PREFERRED_SIZE, 335, Short.MAX_VALUE).add(
						GroupLayout.TRAILING, optionsArea, GroupLayout.PREFERRED_SIZE, 335, Short.MAX_VALUE)).addContainerGap()));
