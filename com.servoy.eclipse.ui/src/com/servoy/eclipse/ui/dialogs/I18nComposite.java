...
public class I18nComposite extends Composite
{
	...
	private final ArrayList<ISelectionChangedListener> languageSelectionListeners = new ArrayList<ISelectionChangedListener>();

	public I18nComposite(Composite parent, int style, IApplication application)
	{
		super(parent, style);
	...
	private void initialise()
	{
		...
		messagesModel = new I18NMessagesModel(application.getSolution(), application.getClientID(), application.getSettings(), application.getDataServer(),
	...
	public void addLanguageSelectionListener(ISelectionChangedListener listener)
	{
		if (languageSelectionListeners.indexOf(listener) == -1) languageSelectionListeners.add(listener);
	}

	public void removeLanguageSelectionListener(ISelectionChangedListener listener)
	{
	...
	private ISelectionChangedListener getLanguageSelectionHandler()
	{
		if (languageSelectionHandler == null)
		{
			languageSelectionHandler = new ISelectionChangedListener()
			{
				...
				{
					for (ISelectionChangedListener listener : languageSelectionListeners)
