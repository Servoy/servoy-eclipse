 ...
 * @since 6.0
 */
public class TableSearch extends DLTKSearchEngineSearch
{

	private final TableWrapper table;

	public TableSearch(TableWrapper table)
	{
		this.table = table;
	}
	...
	public IStatus run(IProgressMonitor monitor) throws OperationCanceledException
	{
		...
		TextSearchEngine.create().search(scope, collector, Pattern.compile("\\bdb:/" + table.getServerName() + "/" + table.getTableName()), monitor);
