...
//	private static String SERVOY_AUX_OPERATOR = "Additional";
	...
	public void providePreferences(IColoringPreferenceRequestor requestor)
	{
		...
		requestor.addPreference(IExecutingEnviroment.TOPLEVEL_JSVALUELIST, IExecutingEnviroment.TOPLEVEL_JSVALUELIST, new RGB(0, 200, 0));
		requestor.addPreference(IExecutingEnviroment.TOPLEVEL_EVENTS_MANAGER, IExecutingEnviroment.TOPLEVEL_EVENTS_MANAGER, new RGB(0, 200, 0));
