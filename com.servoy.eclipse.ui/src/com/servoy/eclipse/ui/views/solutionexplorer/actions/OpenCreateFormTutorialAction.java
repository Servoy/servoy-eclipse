 ...
 *
 */
public class OpenCreateFormTutorialAction extends Action implements ISelectionChangedListener
{
	 ...
	 */
	public OpenCreateFormTutorialAction(SolutionExplorerView sev)
	{
		// TODO Auto-generated constructor stub
		viewer = sev;

		setImageDescriptor(PlatformUI.getWorkbench().getSharedImages().getImageDescriptor(ISharedImages.IMG_TOOL_NEW_WIZARD));
		setText("Create new form");
		setToolTipText("See how to create a new form");
