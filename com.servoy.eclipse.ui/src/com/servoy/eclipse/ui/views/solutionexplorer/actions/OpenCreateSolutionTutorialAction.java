 ...
 *
 */
public class OpenCreateSolutionTutorialAction extends Action implements ISelectionChangedListener
{
	 ...
	 */
	public OpenCreateSolutionTutorialAction(SolutionExplorerView sev)
	{
		// TODO Auto-generated constructor stub
		viewer = sev;

		setImageDescriptor(PlatformUI.getWorkbench().getSharedImages().getImageDescriptor(ISharedImages.IMG_TOOL_NEW_WIZARD));
		setText("Create new solution");
		setToolTipText("See how to create a new solution");
	...
	public static void show()
	{
		Display.getDefault().asyncExec(() -> {
			new BrowserDialog(new Shell(), "https://www.youtube.com/watch?v=hLQCUUkvuKA&feature=youtu.be", false, false).open();
		});
	}
