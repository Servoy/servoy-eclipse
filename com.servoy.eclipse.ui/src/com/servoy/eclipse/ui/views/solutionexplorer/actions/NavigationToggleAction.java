...
/**
 * This action is responsible to add or remove the navigation actions (Go Home, Go Back, Go Into)
 * from the context menu of solex. This action is added to the solex view menu.
 * @author alorincz
 * 
 */
public class NavigationToggleAction extends Action
{
	...
	public void run()
	{
		solexView.showContextMenuNavigationGroup(isChecked());
	}
}
