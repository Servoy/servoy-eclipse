...
public class NewValueListAction extends Action implements ISelectionChangedListener
{
	...
	public void run()
	{
		...
		{
			Pair<String, String> name = askValueListName(viewer.getViewSite().getShell());
			if (name != null)
			{
	...
	public static Pair<String, String> askValueListName(Shell shell)
	{
		...
		ModuleListValueListSelectionDialog nameDialog = new ModuleListValueListSelectionDialog(shell,
			"Please select a module for the valuelist and also supply value list name", "Supply value list name");
