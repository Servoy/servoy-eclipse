...
public class ToggleSnapToGridAction extends ViewerTogglePropertyAction
{
	...
	{
		super(diagramViewer, DesignerActionFactory.TOGGLE_SNAPTO_GRID.getId(), DesignerActionFactory.TOGGLE_SNAPTO_GRID_TEXT,
			DesignerActionFactory.TOGGLE_SNAPTO_GRID_TOOLTIP, DesignerActionFactory.TOGGLE_SNAPTO_GRID_IMAGE, SnapToGrid.PROPERTY_GRID_ENABLED);
	}
}
