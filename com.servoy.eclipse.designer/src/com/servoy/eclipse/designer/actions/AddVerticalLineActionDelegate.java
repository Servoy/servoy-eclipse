...
public class AddVerticalLineActionDelegate extends AddLabelActionDelegate
{
	...
	public AddVerticalLineActionDelegate()
	{
		...
		addExtendedData("borderType", ComponentFactoryHelper.createBorderString(new SpecialMatteBorder(0, 1, 0, 0, Color.black, Color.black, Color.black,
			Color.black)));
		addExtendedData("horizontalAlignment", SwingConstants.RIGHT);
		addExtendedData("transparent", Boolean.TRUE);
		addExtendedData("size", new Dimension(1, 40));
	}
}
