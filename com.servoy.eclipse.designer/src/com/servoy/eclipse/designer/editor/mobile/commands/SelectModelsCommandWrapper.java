 ...
 *
 */
public class SelectModelsCommandWrapper extends RefreshingCommand<Command>
{
	private final ISelectionProvider selectionProvider;

	public SelectModelsCommandWrapper(ISelectionProvider selectionProvider, Command command)
	{
		super(command);
