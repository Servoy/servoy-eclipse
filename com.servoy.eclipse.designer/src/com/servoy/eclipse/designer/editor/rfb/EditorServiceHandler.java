	...
	private void configureHandlers()
	{
		...
		configuredHandlers.put("openInBrowser", new IServerService()
		{
			...
			public Object executeMethod(String methodName, JSONObject args) throws Exception
			{
				...
				// Problem markers and property mismatches are not a reliable signal that a form
				// cannot render - an unresolved event method or dataprovider produces an ERROR
				// marker while the form still renders fine. Always open the form (SVY-21195);
				// the Problems view already reports the markers themselves, so no dialog here.
