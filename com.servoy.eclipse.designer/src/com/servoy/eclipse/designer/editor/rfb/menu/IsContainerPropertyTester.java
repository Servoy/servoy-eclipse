...
public class IsContainerPropertyTester extends PropertyTester
{
	...
	public boolean test(Object receiver, String property, Object[] args, Object expectedValue)
	{
		...
		if (receiver instanceof PersistContext)
		{
			...
			{
				WebObjectSpecification spec = WebComponentSpecProvider.getInstance().getSpecProviderState().getWebComponentSpecification(((WebComponent)persistContext.getPersist()).getTypeName());
