 ...
 *
 */
public class DesignNGClient extends DebugNGClient
{
	...
	{
//		super(wsSession);
		super(wsSession, new IDesignerCallback()
		{

			@Override
			public void testAndStartDebugger()
			{
				// not used for design client (so client showing inside form editors)
			}
