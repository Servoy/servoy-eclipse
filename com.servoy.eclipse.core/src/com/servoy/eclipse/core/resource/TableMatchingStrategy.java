...
public class TableMatchingStrategy implements IEditorMatchingStrategy
{
	public boolean matches(IEditorReference editorRef, IEditorInput input)
	{
		...
		if (editorInput instanceof TableEditorInput && input instanceof FileEditorInput)
		{
			return editorInput.equals(TableEditorInput.createFromFileEditorInput((FileEditorInput)input));
		}
