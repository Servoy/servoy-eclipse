...
public class ServerConfiguration
{
	...
	public ServerConfiguration(String name, ServerConfig config, ServerSettings serverSettings)
	{
		...
		ServerSettings serverSettingsWithDefaults = serverSettings.withDefaults(config);
		queryProcedures = serverSettingsWithDefaults.getQueryProcedures().booleanValue();
		clientOnlyConnections = serverSettingsWithDefaults.getClientOnlyConnections().booleanValue();
	}
