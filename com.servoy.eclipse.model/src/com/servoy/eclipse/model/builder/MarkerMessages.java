...
public class MarkerMessages
{
	...
	public static ServoyMarker ValuelistDBWithCustomValues = new ServoyMarker(
		"Valuelist \"{0}\" is a database valuelist but it also specifies custom values.", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE, "Removed custom values."); //$NON-NLS-2$
	...
	public static ServoyMarker ValuelistRelationWithDatasource = new ServoyMarker(
		"Valuelist \"{0}\" is relation based so it should not specify a datasource.", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE, "Removed datasource."); //$NON-NLS-2$
	...
	public static ServoyMarker ValuelistCustomValuesWithDBInfo = new ServoyMarker(
		"Valuelist \"{0}\" is a custom valuelist so it should not specify table, server or relation.", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE, "Removed table, server and relation."); //$NON-NLS-2$
	...
	public static ServoyMarker FormNoParts = new ServoyMarker("Form \"{0}\" does not have any parts and does not extend a form which has parts.",
		ServoyBuilder.FORM_NO_PARTS_MARKER_TYPE);
