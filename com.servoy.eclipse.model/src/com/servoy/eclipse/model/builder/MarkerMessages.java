...
public class MarkerMessages
{
	...
	public static ServoyMarker MethodNumberOfArgumentsMismatch = new ServoyMarker(
		"Event handler \"{0}\" for {1}{2} called with more arguments than the function deffinition \"{3}\".", ServoyBuilder.METHOD_NUMBER_OF_ARGUMENTS_MISMATCH_TYPE); //$NON-NLS-1$
	...
	public static ServoyMarker ColumnIncompatbleWithUUID = new ServoyMarker(
		"Table \"{0}\" has column \"{1}\" marked as UUID, but the type and/or length are not compatible with UUID (MEDIA:16 or TEXT:36).", ServoyBuilder.COLUMN_MARKER_TYPE); //$NON-NLS-1$
