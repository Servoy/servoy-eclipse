...
public class MarkerMessages
{
	...
	public static ServoyMarker FormFormatIncompatible = new ServoyMarker(
		"Element in form \"{0}\" has incompatible format with its data type (Text) : \"{1}\".", ServoyBuilder.PROJECT_FORM_MARKER_TYPE); //$NON-NLS-1$
	public static ServoyMarker FormFormatOnElementIncompatible = new ServoyMarker(
		"Element \"{0}\" in form \"{1}\" has incompatible format with its data type (Text): \"{2}\".", ServoyBuilder.PROJECT_FORM_MARKER_TYPE); //$NON-NLS-1$
