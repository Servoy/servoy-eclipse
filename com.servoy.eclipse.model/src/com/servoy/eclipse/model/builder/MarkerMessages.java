...
public class MarkerMessages
{
	...
	public static ServoyMarker NoResourceReference = new ServoyMarker(
		"Solution project \"{0}\" has no Servoy Resources Project referenced.", ServoyBuilder.NO_RESOURCES_PROJECTS_MARKER_TYPE);
	...
	public static ServoyMarker PropertyFormCannotBeInstantiated = new ServoyMarker(
		"Property \"{0}\" refers to a form that cannot be instantiated.", ServoyBuilder.SOLUTION_PROBLEM_MARKER_TYPE);
	...
	public static ServoyMarker PropertyMultipleMethodsOnSameTable = new ServoyMarker(
		"Table \"{0}\" has the same method attached to multiple events.", ServoyBuilder.MULTIPLE_METHODS_ON_SAME_ELEMENT);
	...
	public static ServoyMarker RelationGenericError = new ServoyMarker(
		"Relation \"{0}\" is referring to a server table or column which does not exist.", ServoyBuilder.PROJECT_RELATION_MARKER_TYPE);
	...
	public static ServoyMarker SolutionDeserializeError = new ServoyMarker(
		"Error while reading solution \"{0}\": {1}.", ServoyBuilder.PROJECT_DESERIALIZE_MARKER_TYPE);
	...
	public static ServoyMarker SolutionWithHigherFileVersion = new ServoyMarker(
		"{0} \"{1}\" has a higher version of Servoy.", ServoyBuilder.SOLUTION_PROBLEM_MARKER_TYPE);

	public static ServoyMarker SolutionBadStructure_EntityManuallyMoved = new ServoyMarker(
		"Structure of the files for solution \"{0}\" is broken (incorrect parent-child combination). Entity \"{1}\" has been manually moved?", ServoyBuilder.BAD_STRUCTURE_MARKER_TYPE);
	...
	public static ServoyMarker ReservedWindowObjectProperty = new ServoyMarker(
		"Reserved browser window object property name \"{0}\" found.", ServoyBuilder.RESERVED_WINDOW_OBJECT_USAGE_TYPE);
	...
	public static ServoyMarker ReservedWindowObjectColumn = new ServoyMarker(
		"Reserved browser window object table column name \"{0}\" found.", ServoyBuilder.RESERVED_WINDOW_OBJECT_USAGE_TYPE);
	...
	public static ServoyMarker ValuelistDBServerDuplicate = new ServoyMarker(
		"Valuelist \"{0}\" is based on server \"{1}\" which is a duplicate.", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE);
	public static ServoyMarker ValuelistDBWithCustomValues = new ServoyMarker(
		"Valuelist \"{0}\" is a database valuelist but it also specifies custom values.", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE, "Removed custom values.");
	...
	public static ServoyMarker ValuelistDBMalformedTableDefinition = new ServoyMarker(
		"Valuelist \"{0}\" is based on malformed table definition \"{1}\".", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE);
	public static ServoyMarker ValuelistDBTableNotAccessible = new ServoyMarker(
		"Valuelist \"{0}\" is based on table \"{1}\" which is not accessible.", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE);
	public static ServoyMarker ValuelistDBTableNoPk = new ServoyMarker(
		"Valuelist \"{0}\" is based on table \"{1}\" which does not have a primary key.", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE);
	...
	public static ServoyMarker ValuelistRelationWithDatasource = new ServoyMarker(
		"Valuelist \"{0}\" is relation based so it should not specify a datasource.", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE, "Removed datasource.");
	public static ServoyMarker ValuelistRelationNotFound = new ServoyMarker(
		"Valuelist \"{0}\" is based on relation \"{1}\" which is not found.", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE);
	...
	public static ServoyMarker ValuelistCustomValuesWithDBInfo = new ServoyMarker(
		"Valuelist \"{0}\" is a custom valuelist so it should not specify table, server or relation.", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE, "Removed table, server and relation.");
	public static ServoyMarker ValuelistGlobalMethodNotFound = new ServoyMarker(
		"Valuelist \"{0}\" references a nonexisting global method.", ServoyBuilder.PROJECT_VALUELIST_MARKER_TYPE);
	...
	public static ServoyMarker StyleFormClassNotFound = new ServoyMarker(
		"Style class \"{0}\" used in form \"{1}\" does not exist.", ServoyBuilder.MISSING_STYLE);
	public static ServoyMarker StyleElementClassNotFound = new ServoyMarker(
		"Style class \"{0}\" from element \"{1}\" in form \"{2}\" does not exist.", ServoyBuilder.MISSING_STYLE);
	public static ServoyMarker StyleFormClassNoStyle = new ServoyMarker(
		"Style class \"{0}\" in form \"{1}\" is set but no style is assigned to form.", ServoyBuilder.MISSING_STYLE);
	...
	public static ServoyMarker ModuleNotFound = new ServoyMarker(
		"Module \"{0}\" which is referenced by project \"{1}\" does not exist.", ServoyBuilder.MISSING_MODULES_MARKER_TYPE);

	public static ServoyMarker ModuleDifferentI18NTable = new ServoyMarker(
		"Module \"{0}\" has a different i18n table than main solution \"{1}\".", ServoyBuilder.I18N_MARKER_TYPE);
	...
	public static ServoyMarker ItemReferencesInvalidTable = new ServoyMarker(
		"{0} \"{1}\" references invalid table \"{2}\".", ServoyBuilder.INVALID_TABLE_NODE_PROBLEM);

	public static ServoyMarker CalculationFormAccess = new ServoyMarker(
		"Form access found in calculation \"{0}\". This is not supported.", ServoyBuilder.CALCULATION_MARKER_TYPE);
	...
	public static ServoyMarker PropertyTargetNotFound = new ServoyMarker(
		"Property \"{0}\" is linked to an entity that does not exist.", ServoyBuilder.SOLUTION_PROBLEM_MARKER_TYPE);
	...
	public static ServoyMarker PropertyInFormTargetNotFound = new ServoyMarker(
		"Property \"{0}\" in form \"{1}\" is linked to an entity that does not exist.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker PropertyOnElementTargetNotAccessible = new ServoyMarker(
		"Property \"{0}\" from element \"{1}\" is linked to private method \"{2}\" which is not accessible from the context.", ServoyBuilder.SOLUTION_PROBLEM_MARKER_TYPE);
	public static ServoyMarker PropertyInFormTargetNotAccessible = new ServoyMarker(
		"Property \"{0}\" in form \"{1}\" is linked to a private method \"{2}\" which is not accessible from the form.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	public static ServoyMarker PropertyOnElementInFormTargetNotAccessible = new ServoyMarker(
		"Property \"{0}\" from element \"{1}\" in form \"{2}\" is linked to a private method \"{3}\" which is not accessible from the context.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);

	public static ServoyMarker FormTableNoPK = new ServoyMarker(
		"Form \"{0}\" is based on table \"{1}\" which does not have a primary key.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	public static ServoyMarker FormHasTooManyThingsAndProbablyLowPerformance = new ServoyMarker(
		"For performance reasons on the internet/WAN it is strongly suggested to place no more then {0} {1} on a{2} form.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker FormDuplicatePart = new ServoyMarker(
		"Form \"{0}\" has multiple parts of type: \"{1}\".", ServoyBuilder.FORM_DUPLICATE_PART_MARKER_TYPE);

	public static ServoyMarker NonAccessibleFormInModuleUsedInParentSolutionForm = new ServoyMarker(
		"Non-public {0} \"{1}\" from module \"{2}\" is used in solution \"{3}\", in form \"{4}\". This is not allowed.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker FormVariableTableCol = new ServoyMarker(
		"Form \"{0}\" has a variable \"{1}\" which is also a column in table \"{2}\".", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	public static ServoyMarker FormTableNotAccessible = new ServoyMarker(
		"Form \"{0}\" is based on table \"{1}\" which is not accessible.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);

	public static ServoyMarker FormFileNameInconsistent = new ServoyMarker(
		"Form \"{0}\" is saved on disk in a file with a different name( \"{1}\" ).", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker FormExtendsCycle = new ServoyMarker(
		"Form \"{0}\" is part of a cycle through the \"extendsForm\" property.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker FormNamedFoundsetIncorrectValue = new ServoyMarker(
		"\"namedFoundSet\" property of form \"{0}\" is incorrect.{1}", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	public static ServoyMarker FormNamedElementOutsideBoundsOfForm = new ServoyMarker(
		"Element \"{0}\" in form \"{1}\" is outside the bounds of the form.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	public static ServoyMarker FormNamedElementOutsideBoundsOfPart = new ServoyMarker(
		"Element \"{0}\" in form \"{1}\" is outside the bounds of part {2}.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	public static ServoyMarker FormTypeAheadNamedUnstoredCalculation = new ServoyMarker(
		"Type ahead field \"{0}\" has attached a valuelist (or fallback valuelist) that contains unstored calculation(s). This is not supported.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker FormNamedFieldFallbackRelatedValuelist = new ServoyMarker(
		"Field \"{0}\" has attached a valuelist \"{1}\" whose fallback valuelist \"{2}\" is related but doesn''t have the same datasource as {3}.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	/**
	...
	public static ServoyMarker FormLabelForElementNotFound = new ServoyMarker(
		"Label in form \"{0}\" has labelfor property \"{1}\" that does not exist.", ServoyBuilder.LABEL_FOR_ELEMENT_NOT_FOUND_MARKER_TYPE);

	public static ServoyMarker FormExtendsFormElementNotFound = new ServoyMarker(
		"Form \"{0}\" extends a form that cannot be found.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);

	public static ServoyMarker ObsoleteElement = new ServoyMarker(
		"Form \"{0}\" contains an obsolete element type, this should be removed.", ServoyBuilder.OBSOLETE_ELEMENT);
	/**
	...
	public static ServoyMarker FormPortalUnnamedElementUnnamedMismatchedRelation = new ServoyMarker(
		"Element from portal has relation sequence \"{0}\" while portal has relationName \"{1}\". It should be the same value.", ServoyBuilder.PORTAL_DIFFERENT_RELATION_NAME_MARKER_TYPE);
	...
	public static ServoyMarker FormPortalUnnamedElementNamedMismatchedRelation = new ServoyMarker(
		"Element \"{0}\" from portal has relation sequence \"{1}\" while portal has relationName \"{2}\". It should be the same value.", ServoyBuilder.PORTAL_DIFFERENT_RELATION_NAME_MARKER_TYPE);
	...
	public static ServoyMarker FormPortalNamedElementUnnamedMismatchedRelation = new ServoyMarker(
		"Element from portal \"{0}\" has relation sequence \"{1}\" while portal has relationName \"{2}\". It should be the same value.", ServoyBuilder.PORTAL_DIFFERENT_RELATION_NAME_MARKER_TYPE);
	...
	public static ServoyMarker FormPortalNamedElementNamedMismatchedRelation = new ServoyMarker(
		"Element \"{0}\" from portal \"{1}\" has relation sequence \"{2}\" while portal has relationName \"{3}\". It should be the same value.", ServoyBuilder.PORTAL_DIFFERENT_RELATION_NAME_MARKER_TYPE);
	...
	public static ServoyMarker FormPortalUnnamedInvalidRelationName = new ServoyMarker(
		"Portal has invalid relationName (relation chain is not correct).", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker FormRelatedTabUnsolvedRelation = new ServoyMarker(
		"Related tab error: cannot resolve relation sequence \"{0}\".", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker FormRelatedTabUnsolvedUuid = new ServoyMarker(
		"Related tab error: relation UUID was not resolved to relation name \"{0}\".", ServoyBuilder.UNRESOLVED_RELATION_UUID);
	...
	public static ServoyMarker FormPropertyOnElementMethodNotAccessible = new ServoyMarker(
		"Property \"{0}\" from element \"{1}\" in form \"{2}\" is linked to a non accessible method (method belongs to form \"{3}\").", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker FormFormatInvalid = new ServoyMarker(
		"Element in form \"{0}\" has invalid format: \"{1}\".", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	public static ServoyMarker FormFormatOnElementInvalid = new ServoyMarker(
		"Element \"{0}\" in form \"{1}\" has invalid format: \"{2}\".", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker FormFormatOnElementIncompatible = new ServoyMarker(
		"Format not supported on element \"{0}\" from form \"{1}\" as it has a valuelist with real and display values.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);

	public static ServoyMarker RequiredPropertyMissingOnElement = new ServoyMarker(
		"Property \"{0}\" must be set on element \"{1}\", in form \"{2}\".", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker FormDataproviderNotFound = new ServoyMarker(
		"Element in form \"{0}\" has a dataprovider \"{1}\" that does not exist.", ServoyBuilder.INVALID_DATAPROVIDERID);

	/**
	 * The dataprovider used by an element cannot be found. This can happen for example if the structure of a database is changed and columns are deleted or renamed.
	 */
	public static ServoyMarker FormIncompatibleElementType = new ServoyMarker(
		"Element \"{0}\" in form \"{1}\" has an incompatible dataprovider type (MEDIA).", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker MobileFormNavigatorOverlapsHeaderButton = new ServoyMarker(
		"Mobile form navigator and left header button cannot be used in the same time, as the navigator toggle button overlaps the left header button.", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker FormColumnLengthTooSmall = new ServoyMarker(
		"HTML/RTF element \"{0}\" in form \"{1}\" has column dataprovider with small length. This may cause unpredictable results(if length of the value will get bigger than the column length).", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker ColumnIncompatbleWithUUID = new ServoyMarker(
		"Table \"{0}\" has column \"{1}\" marked as UUID, but the type and/or length are not compatible with UUID (MEDIA:16 or TEXT:36).", ServoyBuilder.COLUMN_MARKER_TYPE);
	...
	public static ServoyMarker ColumnLookupInvalid = new ServoyMarker(
		"Table \"{0}\" has column \"{1}\" which has an invalid lookup value.", ServoyBuilder.COLUMN_MARKER_TYPE);
	/**
	...
	public static ServoyMarker ColumnValidatorInvalid = new ServoyMarker(
		"Table \"{0}\" has column \"{1}\" which has an invalid validator.", ServoyBuilder.COLUMN_MARKER_TYPE);
	/**
	...
	public static ServoyMarker ColumnConverterInvalid = new ServoyMarker(
		"Table \"{0}\" has column \"{1}\" which has an invalid converter.", ServoyBuilder.COLUMN_MARKER_TYPE);

	public static ServoyMarker UIConverterInvalid = new ServoyMarker(
		"Element in form \"{0}\" has UI converter: \"{1}\".", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	public static ServoyMarker UIConverterOnElementInvalid = new ServoyMarker(
		"Element \"{0}\" in form \"{1}\" has invalid UI converter: \"{2}\".", ServoyBuilder.PROJECT_FORM_MARKER_TYPE);
	...
	public static ServoyMarker DBIColumnMissingFromDB = new ServoyMarker(
		"Column \"{0}\" appears in the DB information file, but is missing from the DB table.", ServoyBuilder.DATABASE_INFORMATION_MARKER_TYPE);
	...
	public static ServoyMarker DBIColumnConflict = new ServoyMarker(
		"\"{0}\" column difference. {1} in DB <-> {2} in DB information file. The DB information on this column differs from the actual column in the DB.", ServoyBuilder.DATABASE_INFORMATION_MARKER_TYPE);
	public static ServoyMarker DBITableMissing = new ServoyMarker(
		"Table \"{0}\" is missing from the DB (there is a database information file for this table).", ServoyBuilder.DATABASE_INFORMATION_MARKER_TYPE);
	public static ServoyMarker DBIFileMissing = new ServoyMarker(
		"Missing database information file for table \"{0}\" (the table exists in the DB).", ServoyBuilder.DATABASE_INFORMATION_MARKER_TYPE);
	...
	public static ServoyMarker ElementNameInvalidIdentifier = new ServoyMarker(
		"Element has name \"{0}\" which is not a valid identifier.", ServoyBuilder.SOLUTION_PROBLEM_MARKER_TYPE);
	...
	public static ServoyMarker RelationPrimaryTableWithoutPK = new ServoyMarker(
		"Relation \"{0}\" is referring to a primary table \"{1}\" on server \"{2}\" but the primary table does not have a primary key.", ServoyBuilder.PROJECT_RELATION_MARKER_TYPE);
	public static ServoyMarker RelationPrimaryServerDuplicate = new ServoyMarker(
		"Relation \"{0}\" is referring to duplicate primary server \"{1}\".", ServoyBuilder.PROJECT_RELATION_MARKER_TYPE);
	...
	public static ServoyMarker RelationForeignTableWithoutPK = new ServoyMarker(
		"Relation \"{0}\" is referring to a foreign table \"{1}\" on server \"{2}\" but the foreign table does not have a primary key.", ServoyBuilder.PROJECT_RELATION_MARKER_TYPE);
	public static ServoyMarker RelationForeignServerDuplicate = new ServoyMarker(
		"Relation \"{0}\" is referring to a duplicate foreign server \"{1}\".", ServoyBuilder.PROJECT_RELATION_MARKER_TYPE);
	public static ServoyMarker RelationItemNoPrimaryDataprovider = new ServoyMarker(
		"Relation \"{0}\" has an item without primary dataprovider.", ServoyBuilder.PROJECT_RELATION_MARKER_TYPE);
	...
	public static ServoyMarker RelationItemNoForeignDataprovider = new ServoyMarker(
		"Relation \"{0}\" has an item without foreign dataprovider.", ServoyBuilder.PROJECT_RELATION_MARKER_TYPE);
	public static ServoyMarker RelationItemForeignDataproviderNotFound = new ServoyMarker(
		"Relation \"{0}\" has a foreign column \"{1}\" which is not found.", ServoyBuilder.PROJECT_RELATION_MARKER_TYPE);
	...
	public static ServoyMarker RelationItemTypeProblem = new ServoyMarker(
		"Relation \"{0}\" has a relation item with mismatched keys: {1}.", ServoyBuilder.PROJECT_RELATION_MARKER_TYPE);
	public static ServoyMarker RelationItemUUIDProblem = new ServoyMarker(
		"Relation \"{0}\" has a relation item where UUID flag is set for only one column (\"{1}\" - \"{2}\"). Either both columns or neither column should have the UUID flag set.", ServoyBuilder.PROJECT_RELATION_MARKER_TYPE);
	...
	public static ServoyMarker MissingConverter = new ServoyMarker(
		"Converter \"{0}\" has been configured on dataprovider \"{1}\" but cannot be found.", ServoyBuilder.MISSING_CONVERTER);

	public static ServoyMarker ServerCloneCycle = new ServoyMarker(
		"Server \"{0}\" clone data model, cannot reference itself.", ServoyBuilder.SERVER_CLONE_CYCLE_TYPE);

	/**
	 * The element uses deprecated script element. 
	 */
	public static ServoyMarker ElementUsingDeprecatedVariable = new ServoyMarker(
		"Variable \"{0}\" in \"{1}\" as \"{2}\" property while deprecated.", ServoyBuilder.DEPRECATED_SCRIPT_ELEMENT_USAGE);
	public static ServoyMarker ElementUsingDeprecatedFunction = new ServoyMarker(
		"Function \"{0}\" is used in \"{1}\" as \"{2}\" property while deprecated.", ServoyBuilder.DEPRECATED_SCRIPT_ELEMENT_USAGE);
	public static ServoyMarker ElementUsingDeprecatedCalculation = new ServoyMarker(
		"Calculation \"{0}\" is used in \"{1}\" as \"{2}\" property while deprecated.", ServoyBuilder.DEPRECATED_SCRIPT_ELEMENT_USAGE);
}
