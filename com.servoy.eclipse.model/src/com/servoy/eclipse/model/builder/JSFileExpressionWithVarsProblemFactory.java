...
/**
 * Problem identifier factory for multiple variable declarations in the same expression problem
 * @author gboros
 */
public class JSFileExpressionWithVarsProblemFactory implements IProblemIdentifierFactory
{
	...
	{
		return JSFileExpressionWithVarsProblem.valueOf(localName);
	}
	...
	{
		return JSFileExpressionWithVarsProblem.values();
	}
}
